...
const LoginPopUp = ({ onClose, onLogin }) => {
    ...
    return (
        <div className="screen fixed z-10 left-0 top-0 w-full h-full overflow-auto bg-gray-100/40 font-mono">
            <div className="column absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-3/4 md:-translate-y-1/2 flex flex-col w-1/5 bg-gray-200 border-2 border-gray-300 rounded sm:w-3/5 md:w-2/5">
                ...
                <div className="below-cancel flex flex-col">
                    <div className="header-row flex flow-row justify-center p-2">
                        <h1 className="font-bold text-4xl text-center whitespace-nowrap">Log in</h1>
                    </div>
